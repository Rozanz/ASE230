					...
					<div class="row">
						...
						<div class="col-12 col-sm-6 col-lg-3">
							<div class="single_advisor_profile wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
								...
								<div class="advisor_thumb"><a href="ROJAN_KC.php"><img src="im.jpg" alt=""></a>
									<!-- Social Info-->
									<div class="social-info"><a href="ROJAN_KC.php"><i class="fa fa-facebook"></i></a><a href="ROJAN_KC.php"><i class="fa fa-twitter"></i></a><a href="ROJAN_KC.php"><i class="fa fa-linkedin"></i></a></div>
								</div>
								<!-- Team Details-->
								<div class="single_advisor_details_info">
									<h6><?php echo 'ROJAN KC'; ?></h6>
