<?php
	...
	$students = array(
			["name"=>"Rojan KC",
			"major"=>"CIT",
			"DOB"=>"1999-12-31",      #adding new category named DOB in all the array
			"year"=>"Junior",
			"job"=>"Student",
			...
			"dream_job"=>"Pilot",
			"intro"=>"Here I am",
			"quote"=>"Conquer your self discipline",
			"yearpic"=>"he.png",
			"skills"=>[
			...
			"quote"=>"Real fighters are always brothers",
			"skills"=>[
